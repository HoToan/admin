                            ...
                            <div className="box box-info">
                                ...
                                <div className="box-body">
                                    <form action="#" method="post">
                                        ...
                                        <div>
                                            <textarea className="textarea" placeholder="Message" style={{ width: '100%', height: '125px', fontSize: '14px', lineHeight: '18px', border: '1px solid #dddddd', padding: '10px' }} defaultValue={""} />
                                        </div>
                                    </form>
                                </div>
